...
(function() {
  window.onload = function()
  {
      ...
      function openInfoWindow(marker, item, i)
      {
        ...
        var tabs = [];
        var imgHtml = "<span style='font-size:13px;'>"+ item["name"]+"</span><br/><p style='display: block;font-size: 12px; color: red; padding-right:3px;text-align:right;'><a href='" + img.src + "' alt='点击查看原图'  target = '_blank' >请点击查看原图</a></p><p id='demoimg_" + item['type'] + "_" + i + "'><img src='"
